...
parser.add_argument('--test_data_path',
                    default=r"/T51/datasets/release/pan23-multi-author-analysis-dataset3/pan23-multi-author-analysis-dataset3-validation")
parser.add_argument('--output_dir', default=r'/T51/hmj/style_change_detection2023/answer')
parser.add_argument('--dataset', default='dataset3')
parser.add_argument('--max_length', default=256, type=int)
parser.add_argument('--dropout_rate', default=0)
parser.add_argument('--batch_size', default=1)
parser.add_argument('--student_weight_dir', default=r"/T51/hmj/style_change_detection2023/weights_s3")
# 传递属性给args实例
